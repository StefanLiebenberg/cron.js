...
sage.util.date.addMinutes(b,1))}else if(g=b.getMinutes(),e&&this.minutes.indexOf(g)==-1){h=!0;for(f=0;f<d;f++)if(this.minutes[f]>=g){b.setMinutes(this.minutes[f]);h=!1;break}h&&(b.setMinutes(0),sage.util.date.addHours(b,1))}else{g=b.getHours();if(j&&this.hours.indexOf(g)==-1){h=!0;for(f=0;f<i;f++)if(this.hours[f]>=g){b.setHours(this.hours[f]);h=!1;break}b.setMilliseconds(0);b.setSeconds(0);b.setMinutes(0);if(h){sage.util.date.addDays(b,1);b.setHours(0);continue}}g=b.getDay()+1;if(o&&this.weekdays.indexOf(g)==
